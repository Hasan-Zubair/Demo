    ...
    return (
        <PublicLayout>
            <Box>
                ...
                <Typography marginBottom={2}>
                    Please note that the enlisted Terms are solely for Vera Applicants. If you are a Legal Service Provider such as a solicitor, barrister or any other type of legal advisor and wish to discuss working with us, please contact us at legalEase@legalease.pk
                </Typography>
                ...
                <Typography marginBottom={2}>6.2. The Applicant understands and acknowledges that in the case of the release, recirculation, and reuse of any of the Vera confidential material and content, it will be immediately reported and informed to our team by email at <a href='mailto:legalEase@legalease.pk'>legalEase@legalease.pk</a>.</Typography>
